...
def get_args():
    ...
    parser.add_argument('--batch_size', type=int, default=20, help='Batch size used for training and testing')
    parser.add_argument('--train_epochs', type=int, default=300, help='Number of training epochs')
